...
import 'package:abitplay/OnBoarding/intro_screen.dart';
import 'package:abitplay/Screens/Home.dart';
import 'package:abitplay/network_utils/const.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    //     .init("83213edd-fd99-47aa-b67b-8358107813a8", iOSSettings: settings);
    OneSignal.shared.setAppId("83213edd-fd99-47aa-b67b-8358107813a8");
    OneSignal.shared.setLogLevel(OSLogLevel.verbose, OSLogLevel.none);
    ...
    print('required consent is ' + '$requiresConsent');
